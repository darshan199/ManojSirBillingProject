...
<div class="container">
  <h2 onclick="set_mrp()">Customer Bill</h2> <h2 style="float: right;     margin-top: -39px;"> Bill Id #<?= $bill_id ?></h2>
  ...
  <table  class="table table-bordered" > 
            ...
            <tbody >
                ...
                <tr>
                  ...
                  <td><input type="number" class="form-control" id="mrp" onchange="total_amount_calculator()" value="1" name="product_mrp[]" min="1" readonly></td>
  ...
  <br>   
    <form action="generate_customer_bill.php" method="post">        
          ...
          <table class="table table-bordered">
            <tbody>
              <tr>
                ...
                <td style="font-weight: bold;" > <input type="number"   name="product_total" class="form-control" id="total_amount" style="width: 178px;float: right;" readonly> </td> 
              </tr>
            </tbody>
          </table>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="shop_name" id="email" style="text-transform:uppercase" required>
                </div>

                <div class="form-group">
                  <label for="email">CUSTOMER NAME :</label>
                  <input type="text" class="form-control" id="email" name="cust_name" style="text-transform:uppercase" required>
                </div>
                <div class="form-group">
                  <label for="pwd">CONTACT NUMBER : </label>
                  <input type="text" class="form-control" id="pwd" name="cust_contact" required="">
                </div>
                
                <div class="form-group">
                  <label for="pwd">ADDRESS :</label>
                  <input type="TEXT" class="form-control" id="pwd" name="cust_address" required="">
                </div>
