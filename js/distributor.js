...
function add_product() {
	...
	$("#add_product").append(""+
		'<tr>'+
          ...
          '<td><input type="number" value="'+mrp_temp+'"  class="form-control" id="mrp'+product_mrp_index+'" value="0" name="product_mrp[]" onchange="total_amount_calculator()" min="1" ></td>'+
          '<td><input type="number" value="'+rate_temp+'"  class="form-control" id="rate'+product_mrp_index+'" value="0" name="product_rate[]" onchange="total_amount_calculator()" min="1" ></td>'+
